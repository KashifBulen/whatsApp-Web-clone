...
//   backgroundColor: theme.palette.mode === "dark" ? "#f0f2f5" : "#fff",
...
//           <Grid >
//           <List sx={{ backgroundColor: 'white', mb: 0, overflow: 'auto', borderRight: '5px solid gainsboro', borderRightWidth: 'thin',  height: '470px' }}>
//           {data.map((info, index) => (
//               <Box key={info.phone} >
//                   <ListItem button selected={index === 3} >
//                       <ListItemAvatar>
//                           <Avatar alt="Profile Picture" src={info.person} />
//                       </ListItemAvatar>
//                       <ListItemText primary={info.name === '' ? info.phone : info.name} secondary={
//                           <Tooltip id={info.phone} sx={{ maxWidth: '20rem' }} placement="bottom"   >
...
//                                   variant="body2"
//                                   color="textSecondary"
//                                   sx={{ position: 'absolute', top: 0, right: 0, padding: '0.8rem', fontSize:'0.7rem' }}
//                                 >
//                                   {info.time}
//                                 </Typography>
